...
class SettingsScreen extends StatelessWidget {
  ...
  Future<void> _removeCategoryTable(BuildContext context) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Category table cleared')),
    );
  }
  ...
  Future<void> _removeSubcategoryTable(BuildContext context) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Subcategory table cleared')),
    );
  }
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: const Text("Clear Category Table", style: TextStyle(color: Colors.white)),
          ...
          // زر حذف جدول الفئات الفرعية
          SizedBox(
            width: double.infinity,
            child: ElevatedButton.icon(
              icon: const Icon(Icons.delete_forever, color: Colors.white),
              label: const Text("Clear Subcategory Table", style: TextStyle(color: Colors.white)),
          ...
          // زر حذف قاعدة البيانات بالكامل
          SizedBox(
            width: double.infinity,
            child: ElevatedButton.icon(
              icon: const Icon(Icons.delete_sweep, color: Colors.white),
              label: const Text("Delete Entire Database", style: TextStyle(color: Colors.white)),
