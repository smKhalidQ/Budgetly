...
mixin _$QuickAddState {
  ...
  @override
  String toString() {
    return 'QuickAddState(items: $items)';
  }
}
...
abstract mixin class $QuickAddStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<QuickAddItem> items});
}
...
extension QuickAddStatePatterns on QuickAddState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<QuickAddItem> items)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _QuickAddState implements QuickAddState {
  const _QuickAddState({final List<QuickAddItem> items = const []})
      : _items = items;

  final List<QuickAddItem> _items;
  @override
  @JsonKey()
  List<QuickAddItem> get items {
